...
import PlayerEarning from "../PlayerEarning";
      ...
      <div className=" w-full mx-auto p-5 md:p-[12px_12px] lg:p-[16px_20px] bg-neutral-bg-03 ">
        <div className="md:flex items-center w-full">
          <div className="w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 sm:justify-items-end mr-1 mt-1">
              <div className="overflow-hidden w-full pt-4 pb-3 ">
                <p className="font-satoshi-medium  font-medium text-[14px] text-neutral-tertiary leading-[24px] w-full">
                  I’m always looking for new games to play and new people to
                  meet. Also passionate about gaming and I love to talk about it
                  with others.
                </p>
              </div>
              <PlayerEarning />
